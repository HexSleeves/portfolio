...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "Built and published a shared component library used across 22 Bayer applications. Integrates LaunchDarkly feature flags at the component level, React Hook Form validation wrappers, and Element Design tokens. Shipped with Storybook 10 docs, Vitest unit tests, and Playwright component tests in CI.",
  ...
  },
  {
    ...
    title: "Bayer Commerce — Terraform Infrastructure",
    summary:
      "Modular Terraform stacks automating the full AWS infrastructure for Bayer's Global Commerce middleware platform across all environments.",
    description:
      "Designed and implemented modular Terraform stacks for Aurora PostgreSQL, ElastiCache Redis, DynamoDB, S3, Lambda, and API Gateway — with remote S3-backed state, Datadog integration, and Vault-backed secrets. Reusable GitHub Actions composite action handles plan/apply across all Bayer repositories.",
    category: "professional",
    technologies: [
      "Terraform",
      "AWS",
  ...
  },
  {
    ...
    summary:
      "AWS Lambda ETL pipelines integrating SAP ERP data into Bayer's commerce platform, plus a deterministic NestJS workflow engine powering the reporting layer.",
    description:
      "Built Lambda pipelines consuming SAP ERP and SAP Commerce Cloud data via Kafka, SQS, and EventBridge, with CloudWatch and Datadog observability. Integrated a deterministic workflow engine into the NestJS reporting API with provider-based task execution, OpenAPI coverage, and execution tracing.",
    category: "professional",
    technologies: [
      "TypeScript",
      "AWS Lambda",
  ...
  },
  {
    ...
    summary:
      "Internal AI agent workflows automating ticket triage, code generation, and documentation retrieval across Bayer engineering teams.",
    description:
      "Designed agent templates and prompt patterns for ticket triage, code generation, and knowledge retrieval. Integrated agents into JIRA and PR workflows. Reduced manual engineering time by ~50% and established standardized AI usage patterns adopted company-wide.",
    category: "professional",
    technologies: ["TypeScript", "LLM APIs", "NestJS", "JIRA API", "Nx"],
    githubUrl: null,
    liveUrl: null,
    isFeatured: false,
    isPrivate: true,
  ...
  },
  {
    ...
    description:
      "Led cluster optimization, pricing-model adjustments, and Spot Instance orchestration for DNAnexus's production Node.js services. Designed secure cross-account AWS patterns for BYOA workloads using IAM, KMS, and Secrets Manager to enable compliant customer data processing.",
    category: "professional",
    technologies: [
      "AWS",
      "Node.js",
