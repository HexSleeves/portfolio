...
import { Mail, Github, Linkedin, Twitter, MapPin, Copy, Check, Send, Loader2 } from "lucide-react";
    ...
    <>
      <section id="contact" className="py-24 relative">
        ...
        <div className="container relative z-10">
          <div ref={ref} className="grid lg:grid-cols-[1fr_1.1fr] gap-12 items-start">
            ...
            <div>
              ...
              {/* Email CTA */}
              <div className={`mb-8 transition-all duration-700 delay-100 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                <div
                  className="flex items-center justify-between gap-4 p-4 rounded-xl border"
                  style={{ background: "oklch(0.11 0.012 265)", borderColor: "oklch(0.82 0.15 200 / 20%)" }}
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      style={{ background: "oklch(0.16 0.012 265)", color: "oklch(0.52 0.015 250)", fontFamily: "'Inter', sans-serif" }}
                    >
              ...
              {/* Social links */}
              <div className={`flex flex-wrap gap-4 transition-all duration-700 delay-200 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                {[
                  ...
                  <a
                    ...
                    style={{ background: "oklch(0.11 0.012 265)", borderColor: "oklch(1 0 0 / 8%)" }}
                    onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.borderColor = "oklch(0.82 0.15 200 / 40%)"; }}
                  ...
                  >
                    ...
                    <div>
                      <div className="text-xs font-medium" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.94 0.005 240)" }}>{label}</div>
                      <div className="text-xs" style={{ fontFamily: "'JetBrains Mono', monospace", color: "oklch(0.52 0.015 250)" }}>{handle}</div>
                    </div>
                  </a>
                ))}
              </div>
            ...
            <div className={`transition-all duration-700 delay-150 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              ...
              >
                ...
                <p className="text-xs mb-6" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.52 0.015 250)" }}>
                ...
                {formState === "success" ? (
                  <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
                    ...
                    >
                      <Check size={22} style={{ color: "oklch(0.82 0.15 200)" }} />
                    </div>
                    <p className="font-semibold" style={{ fontFamily: "'Space Grotesk', sans-serif", color: "oklch(0.94 0.005 240)" }}>
                      Message sent!
                    </p>
                    <p className="text-sm" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.52 0.015 250)" }}>
                  ...
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="from_name" className="block text-xs mb-1.5" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.65 0.01 240)" }}>
                          Name
                        </label>
                        <input
                          ...
                          style={inputStyle}
                          onFocus={(e) => { e.currentTarget.style.borderColor = "oklch(0.82 0.15 200 / 50%)"; }}
                          onBlur={(e)  => { e.currentTarget.style.borderColor = "oklch(1 0 0 / 10%)"; }}
                        />
                      </div>
                      <div>
                        <label htmlFor="from_email" className="block text-xs mb-1.5" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.65 0.01 240)" }}>
                          Email
                        </label>
                        <input
                    ...
                    <div>
                      <label htmlFor="subject" className="block text-xs mb-1.5" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.65 0.01 240)" }}>
                        Subject
                      </label>
                      <input
                    ...
                    <div>
                      <label htmlFor="message" className="block text-xs mb-1.5" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.65 0.01 240)" }}>
                        Message
                      </label>
                      <textarea
                    ...
                    <button
                      ...
                      style={{
                        background: formState === "sending" ? "oklch(0.62 0.12 200)" : "oklch(0.82 0.15 200)",
      ...
      <footer className="border-t py-8" style={{ borderColor: "oklch(1 0 0 / 5%)" }}>
        <div className="container flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs opacity-40" style={{ fontFamily: "'JetBrains Mono', monospace", color: "oklch(0.94 0.005 240)" }}>~/</span>
            <span className="text-sm font-semibold" style={{ fontFamily: "'Space Grotesk', sans-serif", color: "oklch(0.52 0.015 250)" }}>Jacob LeCoq</span>
          </div>
          <div className="flex items-center gap-2">
