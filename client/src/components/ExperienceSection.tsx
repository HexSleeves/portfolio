        ...
        <div ref={ref}>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{ background: "linear-gradient(to bottom, oklch(0.82 0.15 200), oklch(0.82 0.15 200 / 0%))" }}
            />
              ...
              {experience.map((job, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ background: job.current ? "oklch(0.82 0.15 200)" : "oklch(0.35 0.01 265)" }}
                  />
                  ...
                  <div className="gradient-border rounded-lg p-6">
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                      <div>
                        ...
                        <p
                          className="text-sm"
                          style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.82 0.15 200)" }}
                        >
                          {job.role}
                        </p>
                      </div>
                    ...
                    <ul className="space-y-2">
                      {job.highlights.map((h, hi) => (
                        ...
                        >
                          <span style={{ color: "oklch(0.82 0.15 200)", flexShrink: 0, marginTop: "2px" }}>›</span>
                          {h}
                        </li>
                      ))}
                    </ul>
