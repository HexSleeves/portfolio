      ...
      <div className="container py-12">
        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <p className="text-base leading-relaxed"
                  ...
                  I'm a Senior Software Engineer based in Lafayette, Louisiana, with 8+ years of experience building production systems across genomics, agriculture, food delivery, and federal contracting. I specialize in full-stack TypeScript, cloud infrastructure, and AI-powered developer tooling.
                </p>
                <p className="text-base leading-relaxed"
                  style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.75 0.01 240)" }}>
                  My current work at Bayer involves leading full-stack delivery across a large Nx monorepo, designing AI agent workflows that reduce engineering time by ~50%, and acting as DevOps lead for CI/CD standards across multiple teams.
                </p>
                <p className="text-base leading-relaxed"
                  style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.75 0.01 240)" }}>
                  Outside of work, I maintain several open source projects including <a href="https://github.com/HexSleeves/tailscale-mcp" target="_blank" rel="noopener noreferrer" style={{ color: "oklch(0.82 0.15 200)" }}>tailscale-mcp</a> (87+ GitHub stars), the Waggle multi-agent orchestration framework for Go, and RuneForge — a Rust library for building roguelike games.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            {/* Contact card */}
            <div className="gradient-border rounded-xl p-6 space-y-4" style={{ borderColor: "oklch(0.82 0.15 200 / 20%)" }}>
              ...
              <div className="space-y-3">
                ...
                <a href="https://linkedin.com/in/jacob-lecoq" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 text-sm transition-colors"
                  style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.65 0.01 240)" }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = "oklch(0.82 0.15 200)")}
                  onMouseLeave={(e) => (e.currentTarget.style.color = "oklch(0.65 0.01 240)")}>
            ...
            <div className="gradient-border rounded-xl p-6">
              ...
              <Link href="/resume">
                <span className="flex items-center gap-1.5 text-xs mt-4 transition-colors cursor-pointer"
