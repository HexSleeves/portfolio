...
export default function ProjectDetail() {
  ...
  const { data: project, isLoading, error } = trpc.projects.bySlug.useQuery({ slug: slug ?? "" }, { enabled: !!slug });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: "oklch(0.085 0.012 265)" }}>
        ...
        <div className="text-center mt-20">
          <p className="font-mono text-cyan-400 mb-4 text-5xl font-bold" style={{ fontFamily: "'JetBrains Mono', monospace" }}>404</p>
          <Link href="/projects">
            <span className="text-slate-400 hover:text-slate-100 transition-colors text-sm cursor-pointer">← Back to projects</span>
          </Link>
        </div>
      </div>
    );
        ...
        <div className="container max-w-3xl">
          ...
          <Link href="/projects">
            <span
              ...
              onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = "oklch(0.82 0.15 200)")}
              onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = "oklch(0.52 0.015 250)")}
            >
              <ArrowLeft size={14} />
              Back to projects
            </span>
            ...
            <div className="flex items-center gap-3 mt-4">
              {project.githubUrl && (
                <a href={project.githubUrl} target="_blank" rel="noopener noreferrer"
                  ...
                  style={{ background: "oklch(0.16 0.012 265)", borderColor: "oklch(1 0 0 / 8%)", color: "oklch(0.94 0.005 240)", fontFamily: "'Inter', sans-serif" }}>
            ...
            {project.isPrivate && (
              <div className="p-4 rounded-lg border"
                ...
                <p className="text-sm" style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.52 0.015 250)" }}>
                  ...
                  <a href="mailto:lecoqjacob@gmail.com" style={{ color: "oklch(0.82 0.15 200)" }}>reach out</a>{" "}
                  for more details.
                </p>
              </div>
            )}
