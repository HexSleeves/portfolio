...
import { Code2 as Github, Edit, Lock, Plus, Star, Trash2 } from "lucide-react";
import { Link } from "wouter";
import { toast } from "sonner";

const CATEGORY_COLORS: Record<string, { bg: string; text: string }> = {
  "open-source": {
    bg: "oklch(0.82 0.15 200 / 10%)",
    text: "oklch(0.82 0.15 200)",
  },
  professional: {
    bg: "oklch(0.75 0.18 145 / 10%)",
        ...
        {isLoading ? (
          ...
          <div className="space-y-2">
            {projects.map(project => {
              const catColor =
                CATEGORY_COLORS[project.category ?? "personal"] ??
